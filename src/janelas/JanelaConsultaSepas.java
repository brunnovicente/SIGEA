 ...
 */
public class JanelaConsultaSepas extends javax.swing.JDialog {
     ...
     */
    public JanelaConsultaSepas(java.awt.Frame parent, boolean modal) {
        super(parent, modal);
        initComponents();
    ...
    private void initComponents() {
        ...
        setTitle("Consulta de Amostras - CEPAS - Livro");
        ...
        jtabela.setModel(new javax.swing.table.DefaultTableModel(
            ...
            new String [] {
                "Ordem", "CódigoL", "Nome", "Data", "Idade", "Caixa", "N", "Sexo", "Observação"
            }
        ) {
        ...
        if (jtabela.getColumnModel().getColumnCount() > 0) {
            ...
            jtabela.getColumnModel().getColumn(6).setPreferredWidth(15);
            jtabela.getColumnModel().getColumn(7).setPreferredWidth(15);
    ...
    private void jButton2ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton2ActionPerformed
        this.dispose();
        JanelaConsultaSepasReal janela = new JanelaConsultaSepasReal(this.parent, true);
        janela.setVisible(true);        // TODO add your handling code here:
    }//GEN-LAST:event_jButton2ActionPerformed

    private void jButton3ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton3ActionPerformed
        JanelaCadastroLivro janela = new JanelaCadastroLivro(this.parent, true);
     ...
     private void buscaLivro(){
         this.limparTabela();
         BuscaLivro processo = new BuscaLivro(jmensagem,jtabela, this.lista);
         processo.start();
         jbusca.setText("");
        jbusca.requestFocus();
     ...
     private void buscaLivroCodigo(){
        this.limparTabela();
        this.lista = Banco.getBanco().consultaLivro(jbusca.getText());
